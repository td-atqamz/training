...
nose_img = cv2.imread("meeting_13-PigFaceFilter/pig_nose.png")
cap.set(3, 640)  # width
...
while True:
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            nose_width = int(
                hypot(rightnosex - leftnosex, rightnosey - leftnosey * 1.2)
            )
            ...
            )  # Untuk menghapus bagian hidung (menggunakan operator bitwise_and)
