...
detector = (
    fmd.FaceMesh()
)  # Inisialisasi object detector dari class FaceMesh yang sudah di buat

cap = cv2.VideoCapture(0)
cap.set(3, 1280)  # mengatur lebar canvas
cap.set(4, 960)  # mengatur tinggi canvas
left_eye = cv2.imread("meeting_15-DragonFaceFilter/assets/eye1.png")
right_eye = cv2.imread("meeting_15-DragonFaceFilter/assets/eye2.png")
smoke_animation = cv2.VideoCapture(
    "meeting_15-DragonFaceFilter/assets/smoke_animation.mp4"
)
